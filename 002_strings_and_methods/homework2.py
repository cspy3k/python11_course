...
print(example_string2[0:5].capitalize() + example_string2[5:15].lower())
...
print(example_string4[:17].capitalize() + example_string4[17:21].capitalize())
...
price = float(example_string5[11:18])
if price > 500:
    print(True)
else:
    print(False)